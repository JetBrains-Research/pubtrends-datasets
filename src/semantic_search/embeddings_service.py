...
def fetch_texts_embedding_batch(texts, embeddings_service_url, session: requests.Session):
...
def fetch_texts_embedding(texts, embeddings_service_url, batch_size=256):
    ...
    with requests.Session() as session:
        for texts_batch in texts_batches:
            embeddings.extend(fetch_texts_embedding_batch(texts_batch, embeddings_service_url, session))
